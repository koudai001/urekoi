    ...
    <>
      ...
      <div className="mx-auto w-full max-w-md px-14 pt-6">
        ...
        <Button
          ...
          onClick={onNext}
          className="mt-8 h-auto w-full cursor-pointer rounded-full bg-gradient-to-br from-primary to-primary py-4 text-base font-bold text-white hover:opacity-90"
        >
